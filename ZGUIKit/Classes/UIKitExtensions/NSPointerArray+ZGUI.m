...
//
//  NSPointerArray+ZGUI.m
//  ZGUIKit
//
//  Created by ZGUI Team on 2018/4/12.
//

#import "NSPointerArray+ZGUI.h"
#import "ZGUICore.h"

@implementation NSPointerArray (ZGUI)
...
- (NSUInteger)zgui_indexOfPointer:(nullable void *)pointer {
    if (!pointer) {
        return NSNotFound;
    }
...
- (BOOL)zgui_containsPointer:(void *)pointer {
    if (!pointer) {
        return NO;
    }
    if ([self zgui_indexOfPointer:pointer] != NSNotFound) {
        return YES;
    }
    return NO;
}
