...
@interface ZGUIHelper (ZGUI_Interface)
 ...
 *  @see [ZGUIConfiguration automaticallyRotateDeviceOrientation]
 */
 ...
 *  @see [ZGUIHelper rotateToDeviceOrientation]
 */
