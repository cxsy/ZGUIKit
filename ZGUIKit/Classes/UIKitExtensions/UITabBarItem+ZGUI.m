...
@implementation UITabBarItem (ZGUI)

ZGUISynthesizeIdCopyProperty(zgui_doubleTapBlock, setZgui_doubleTapBlock)

- (UIImageView *)zgui_imageView {
    return [self.class zgui_imageViewInTabBarButton:self.zgui_view];
}

+ (UIImageView *)zgui_imageViewInTabBarButton:(UIView *)tabBarButton {
