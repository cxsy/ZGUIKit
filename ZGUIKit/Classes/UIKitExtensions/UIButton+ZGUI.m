...
@implementation UIButton (ZGUI)

ZGUISynthesizeIdStrongProperty(qbt_titleAttributes, setQbt_titleAttributes)
ZGUISynthesizeIdStrongProperty(qbt_customizeButtonPropDict, setQbt_customizeButtonPropDict)
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setTitle:forState:), NSString *, UIControlState, ^(UIButton *selfObject, NSString *title, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeTitle forState:state value:title];
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setTitleColor:forState:), UIColor *, UIControlState, ^(UIButton *selfObject, UIColor *color, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeTitleColor forState:state value:color];
            ...
            if (attributes) {
                ...
                [selfObject zgui_setTitleAttributes:[NSDictionary dictionaryWithDictionary:newAttributes] forState:state];
            }
        });
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setTitleShadowColor:forState:), UIColor *, UIControlState, ^(UIButton *selfObject, UIColor *color, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeTitleShadowColor forState:state value:color];
        });
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setImage:forState:), UIImage *, UIControlState, ^(UIButton *selfObject, UIImage *image, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeImage forState:state value:image];
        });
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setBackgroundImage:forState:), UIImage *, UIControlState, ^(UIButton *selfObject, UIImage *image, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeBackgroundImage forState:state value:image];
        });
        ...
        ExtendImplementationOfVoidMethodWithTwoArguments([UIButton class], @selector(setAttributedTitle:forState:), NSAttributedString *, UIControlState, ^(UIButton *selfObject, NSAttributedString *title, UIControlState state) {
            [selfObject _markZGUICustomizeType:ZGUICustomizeButtonPropTypeAttributedTitle forState:state value:title];
        });
...
- (instancetype)zgui_initWithImage:(UIImage *)image title:(NSString *)title {
...
- (BOOL)zgui_hasCustomizedButtonPropForState:(UIControlState)state {
...
- (BOOL)zgui_hasCustomizedButtonPropWithType:(ZGUICustomizeButtonPropType)type forState:(UIControlState)state {
...
- (void)zgui_setTitleAttributes:(NSDictionary<NSAttributedStringKey,id> *)attributes forState:(UIControlState)state {
    if (!attributes) {
    ...
    if (self.qbt_titleAttributes.count && !self.qbt_titleAttributes[@(UIControlStateNormal)]) {
        [self zgui_setTitleAttributes:@{} forState:UIControlStateNormal];
    }
}
...
- (void)_markZGUICustomizeType:(ZGUICustomizeButtonPropType)type forState:(UIControlState)state value:(id)value {
    if (value) {
        [self _setZGUICustomizeType:type forState:state];
    } else {
        [self _removeZGUICustomizeType:type forState:state];
    }
}

- (void)_setZGUICustomizeType:(ZGUICustomizeButtonPropType)type forState:(UIControlState)state {
    if (!self.qbt_customizeButtonPropDict) {
...
- (void)_removeZGUICustomizeType:(ZGUICustomizeButtonPropType)type forState:(UIControlState)state {
    if (!self.qbt_customizeButtonPropDict || !self.qbt_customizeButtonPropDict[@(state)]) {
        return;
    }
