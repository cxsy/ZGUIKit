...
@implementation NSMethodSignature (ZGUI)

+ (NSMethodSignature *)zgui_avoidExceptionSignature {
...
- (const char *)zgui_typeEncoding {
    return self.zgui_typeString.UTF8String;
}
