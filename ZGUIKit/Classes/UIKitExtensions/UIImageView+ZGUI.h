...
/**
 是否要用 ZGUI 提供的高性能方式去渲染由 [UIImage animatedImage] 创建的 UIImage，（系统原生的方式在 UIImageView 被放在 UIScrollView 内时会卡顿），默认为 NO。
 */
@property(nonatomic, assign) BOOL zgui_smoothAnimation;
