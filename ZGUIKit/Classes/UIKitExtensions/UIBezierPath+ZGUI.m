...
@implementation UIBezierPath (ZGUI)

+ (UIBezierPath *)zgui_bezierPathWithRoundedRect:(CGRect)rect cornerRadiusArray:(NSArray<NSNumber *> *)cornerRadius lineWidth:(CGFloat)lineWidth {
