...
//  ZGUIKit
//
//  Created by ZGUI Team on 2018/8/14.
//
...
OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void))) {
    ...
    if (hasOverride) {
        ...
        const char *typeEncoding = method_getTypeEncoding(originMethod) ?: [targetClass instanceMethodSignatureForSelector:targetSelector].zgui_typeEncoding;
 ...
 */
#define _ZGUITypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_ZGUITypeEncodingDetectorGenerator(Char, char)
_ZGUITypeEncodingDetectorGenerator(Int, int)
_ZGUITypeEncodingDetectorGenerator(Short, short)
_ZGUITypeEncodingDetectorGenerator(Long, long)
_ZGUITypeEncodingDetectorGenerator(LongLong, long long)
_ZGUITypeEncodingDetectorGenerator(NSInteger, NSInteger)
_ZGUITypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_ZGUITypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_ZGUITypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_ZGUITypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_ZGUITypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_ZGUITypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_ZGUITypeEncodingDetectorGenerator(Float, float)
_ZGUITypeEncodingDetectorGenerator(Double, double)
_ZGUITypeEncodingDetectorGenerator(CGFloat, CGFloat)
_ZGUITypeEncodingDetectorGenerator(BOOL, BOOL)
_ZGUITypeEncodingDetectorGenerator(Void, void)
_ZGUITypeEncodingDetectorGenerator(Character, char *)
_ZGUITypeEncodingDetectorGenerator(Object, id)
_ZGUITypeEncodingDetectorGenerator(Class, Class)
_ZGUITypeEncodingDetectorGenerator(Selector, SEL)
...
#define _ZGUIGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_ZGUIGetIvarValueGenerator(Char, char)
_ZGUIGetIvarValueGenerator(Int, int)
_ZGUIGetIvarValueGenerator(Short, short)
_ZGUIGetIvarValueGenerator(Long, long)
_ZGUIGetIvarValueGenerator(LongLong, long long)
_ZGUIGetIvarValueGenerator(UnsignedChar, unsigned char)
_ZGUIGetIvarValueGenerator(UnsignedInt, unsigned int)
_ZGUIGetIvarValueGenerator(UnsignedShort, unsigned short)
_ZGUIGetIvarValueGenerator(UnsignedLong, unsigned long)
_ZGUIGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_ZGUIGetIvarValueGenerator(Float, float)
_ZGUIGetIvarValueGenerator(Double, double)
_ZGUIGetIvarValueGenerator(BOOL, BOOL)
_ZGUIGetIvarValueGenerator(Character, char *)
_ZGUIGetIvarValueGenerator(Selector, SEL)
...
/**
 ...
 int count = zgui_getProjectClassList(&classes);
 Class class = (__bridge Class)classes[0];
 @endcode
 */
FOUNDATION_EXPORT int zgui_getProjectClassList(classref_t **classes);
/**
 检测是否存在某个dyld  image
 */
FOUNDATION_EXPORT BOOL zgui_exists_dyld_image(const char *target_image_name);
